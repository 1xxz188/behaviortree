...
func fixtureProject() model.Project {
	...
	p := model.Project{SchemaVersion: model.SchemaVersion, NextEventID: "2", Name: "generated runtime tests", Generation: model.Generation{PackagePath: "generated", ContextType: "*testContext"}, Blackboard: []model.Field{{ID: "enabled", Name: "Enabled", Type: bt.BoolType}}, Events: []model.EventDefinition{{ID: "1", Name: "继续", CodeName: "Resume"}}, Catalog: []model.Definition{{ID: "ok", Name: "成功", Kind: model.DefinitionAction, GoName: "Pass", Params: []model.Parameter{{Name: "Label", Type: bt.StringType}}}, {ID: "fail", Name: "失败", Kind: model.DefinitionAction, GoName: "Fail", Params: []model.Parameter{{Name: "Label", Type: bt.StringType}}}, {ID: "hold", Name: "异步", Kind: model.DefinitionAction, GoName: "Hold", Params: []model.Parameter{{Name: "Label", Type: bt.StringType}}, EventIDs: []string{"1"}}, {ID: "flaky", Name: "重试", Kind: model.DefinitionAction, GoName: "Flaky", Params: []model.Parameter{{Name: "Label", Type: bt.StringType}}}, {ID: "gate", Name: "条件", Kind: model.DefinitionCondition, GoName: "Gate", Params: []model.Parameter{{Name: "Flag", Type: bt.BoolType}}}}}
