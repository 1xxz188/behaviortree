...
func TestReadableCodeNames(t *testing.T) {
	...
	p := model.Project{SchemaVersion: model.SchemaVersion, NextEventID: "1", Name: "可读命名", Generation: model.Generation{PackagePath: "generated", ContextType: "any"}, Trees: []model.Tree{
...
func TestReadableReferenceNames(t *testing.T) {
	p := model.Project{SchemaVersion: model.SchemaVersion, NextEventID: "1", Name: "可读调用", Generation: model.Generation{PackagePath: "generated", ContextType: "any"}, Trees: []model.Tree{
...
func TestDeepReferenceNamesStayBounded(t *testing.T) {
	p := model.Project{SchemaVersion: model.SchemaVersion, NextEventID: "1", Name: "深调用", Generation: model.Generation{PackagePath: "generated", ContextType: "any"}}
	for i := 0; i < 8; i++ {
...
func TestCodeNameVersionNormalization(t *testing.T) {
	p := model.Project{SchemaVersion: model.SchemaVersion, NextEventID: "1", Name: "版本补全", Generation: model.Generation{PackagePath: "generated", ContextType: "any"}, Trees: []model.Tree{
