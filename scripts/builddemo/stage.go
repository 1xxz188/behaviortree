...
// generatedTreeName 只匹配生成器保留的顶层树文件名，避免漏掉旧树或排除业务 helper。
var generatedTreeName = regexp.MustCompile(`^tree_[A-Za-z0-9_]{1,80}\.gen\.go$`)
...
func stageBehavior(src, dst, module string) error {
	return filepath.WalkDir(src, func(path string, entry fs.DirEntry, walkErr error) error {
		...
		if generatedTreeName.MatchString(rel) && (bytes.HasPrefix(data, []byte("// Code generated by behaviortree/codegen; DO NOT EDIT.\n")) || bytes.HasPrefix(data, []byte("// Code generated by behaviortree/codegen; DO NOT EDIT.\r\n"))) {
			return nil
		}
