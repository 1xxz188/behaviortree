...
func TestStageDoesNotCopyGeneratedAndKeepsHelpers(t *testing.T) {
	...
	for name, data := range map[string]string{
		...
		"tree_main.gen.go":        "// Code generated by behaviortree/codegen; DO NOT EDIT.\ninvalid stale source",
		"tree_Shared.gen.go":      "// Code generated by behaviortree/codegen; DO NOT EDIT.\r\ninvalid stale source",
	} {
	...
	for _, name := range []string{"tree_gen.map.json", "glue.gen.go", "tree_main.gen.go", "tree_Shared.gen.go"} {
